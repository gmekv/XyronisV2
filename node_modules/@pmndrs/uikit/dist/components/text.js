...
export function createText(parentContext, textSignal, fontFamilies, style, properties, defaultProperties, object) {
    ...
    const customLayouting = createInstancedText(mergedProperties, textSignal, globalMatrix, nodeSignal, flexState, isVisible, parentContext.clippingRect, orderInfo, fontSignal, parentContext.root.gylphGroupManager, undefined, undefined, undefined, undefined, initializers, 'break-word');
