...
export declare function loadResourceWithParams<P, R, A extends Array<unknown>>(target: Signal<R | undefined>, fn: (param: P, ...additional: A) => Promise<R>, cleanup: ((value: R) => void) | undefined, initializers: Initializers, param: Signal<P> | P, ...additionals: A): void;
export declare function createNode(target: Signal<FlexNode | undefined> | undefined, state: FlexNodeState, parentContext: ParentContext, mergedProperties: Signal<MergedProperties>, object: Object3DRef, objectVisibleDefault: boolean, initializers: Initializers): void;
