...
import { applyAppearancePropertiesToGroup, computedGlobalMatrix, computedHandlers, computedIsVisible, computedMergedProperties, createNode, disposeGroup, keepAspectRatioPropertyTransformer, loadResourceWithParams, } from './utils.js';
...
export function createSvg(parentContext, style, properties, defaultProperties, object, childrenContainer) {
    ...
    createScrollbars(mergedProperties, scrollPosition, flexState, globalMatrix, isVisible, parentContext.clippingRect, orderInfo, parentContext.root.panelGroupManager, scrollbarWidth, initializers);
    ...
    const scrollHandlers = computedScrollHandlers(scrollPosition, parentContext.anyAncestorScrollable, flexState, object, scrollbarWidth, properties, parentContext.root, initializers);
