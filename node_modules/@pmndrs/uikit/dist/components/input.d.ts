...
export declare function createInput(parentContext: ParentContext, fontFamilies: Signal<FontFamilies | undefined>, style: Signal<InputProperties | undefined>, properties: Signal<InputProperties | undefined>, defaultProperties: Signal<AllOptionalProperties | undefined>, object: Object3DRef): {
    ...
    mergedProperties: import("@preact/signals-core").ReadonlySignal<import("../properties/merged.js").MergedProperties>;
...
export declare function createHtmlInputElement(value: Signal<string>, selectionRange: Signal<Vector2Tuple | undefined>, onChange: (value: string) => void, multiline: boolean, type: Signal<InputType>, disabled: Signal<boolean>, tabIndex: Signal<number>, initializers: Initializers): Signal<HTMLInputElement | HTMLTextAreaElement | undefined>;
