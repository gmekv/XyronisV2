...
export { basedOnPreferredColorScheme, setPreferredColorScheme, getPreferredColorScheme, isDarkMode, type PreferredColorScheme, } from './dark.js';
...
export type { ImageProperties, ContainerProperties, ContentProperties, CustomContainerProperties, IconProperties, InputProperties, RootProperties, SvgProperties, TextProperties, VideoProperties, } from './components/index.js';
