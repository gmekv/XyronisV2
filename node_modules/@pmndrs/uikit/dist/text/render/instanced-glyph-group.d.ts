...
export declare class GlyphGroupManager {
    ...
    private object;
    private map;
    constructor(renderOrder: Signal<number>, depthTest: Signal<boolean>, pixelSize: Signal<number>, root: WithCameraDistance & Pick<RootContext, 'requestRender' | 'onFrameSet'>, object: Object3DRef, initializers: Initializers);
    private traverse;
...
export declare class InstancedGlyphGroup {
    ...
    constructor(renderOrder: number, depthTest: boolean, object: Object3DRef, font: Font, pixelSize: Signal<number>, root: WithCameraDistance & Pick<RootContext, 'requestRender'>, orderInfo: OrderInfo);
