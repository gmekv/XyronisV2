...
export class FlexNode {
    ...
    commit(parentDirection) {
        ...
        if (this.customLayouting != null &&
            untracked(() => properties.read(parentDirectionVertical ? 'minHeight' : 'minWidth', undefined)) === undefined) {
        ...
        if (untracked(() => properties.read('flexShrink', undefined)) == null) {
            const hasHeight = untracked(() => properties.read('height', undefined)) != null;
