...
export declare class PanelGroupManager {
    ...
    private object;
    private map;
    constructor(renderOrder: Signal<number>, depthTest: Signal<boolean>, pixelSize: Signal<number>, root: WithCameraDistance & Pick<RootContext, 'onFrameSet' | 'requestRender'>, object: Object3DRef, initializers: Initializers);
    private traverse;
...
export declare class InstancedPanelGroup {
    ...
    constructor(renderOrder: number, depthTest: boolean, object: Object3DRef, materialClass: MaterialClass, pixelSize: Signal<number>, root: WithCameraDistance & Pick<RootContext, 'requestRender'>, orderInfo: OrderInfo, meshReceiveShadow: boolean, meshCastShadow: boolean);
    private updateCount;
